-- Corrigir mensagem da Caroline diretamente
...
-- Inserir resposta do bot para Caroline
...
VALUES (
  'info',
  'manual_processing',
  'Correção manual da fila de mensagens executada',
  jsonb_build_object(
    'caroline_processed', true,
    'invalid_messages_cleaned', true,
    'timestamp', now()
  )
);